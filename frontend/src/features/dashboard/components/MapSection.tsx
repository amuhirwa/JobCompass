  ...
  return (
    <Card className="w-full h-[500px]">
      ...
      <CardContent className="h-full">
        ...
        <div className="h-full bg-muted/30 rounded-lg flex flex-col items-center justify-center text-muted-foreground border-2 border-dashed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full max-w-2xl">
            <div className="bg-background border rounded-lg p-4 space-y-2">
              <div className="flex items-center gap-2">
                ...
                <span className="font-medium">Tech Hub District</span>
              </div>
            ...
            <div className="bg-background border rounded-lg p-4 space-y-2">
              <div className="flex items-center gap-2">
                ...
                <span className="font-medium">Innovation Quarter</span>
              </div>
              <p className="text-sm text-muted-foreground">
