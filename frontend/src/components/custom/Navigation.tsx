    ...
    >
      <div className="w-full flex items-center justify-between">
        ...
        <div className="hidden nav:flex items-center gap-3">
          ...
          <button className="px-5 py-2 rounded border border-tabiya-accent bg-tabiya-accent text-white font-sans text-base font-medium hover:bg-tabiya-accent/90 transition-colors duration-200">
            Sign Up
          </button>
        </div>
          ...
          <div className="flex flex-col gap-2 p-4 max-h-[80vh] overflow-y-auto">
            ...
            <div className="border-t border-gray-200/20 pt-4 mt-4">
              <div className="flex gap-2">
                ...
                <button className="flex-1 px-5 py-2 rounded border border-tabiya-accent bg-tabiya-accent text-white font-sans text-base font-medium hover:bg-tabiya-accent/90 transition-colors duration-200">
                  Sign Up
                </button>
              </div>
            </div>
