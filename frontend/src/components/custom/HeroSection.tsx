...
export const HeroSection = () => {
  return (
    <section className="w-full px-4 sm:px-8 md:px-12 lg:px-16 py-12 md:py-16 lg:py-20 bg-tabiya-dark relative overflow-hidden">
      {/* Background Elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-tabiya-dark via-tabiya-dark/90 to-tabiya-medium/50"></div>

        {/* Floating geometric shapes */}
        <div className="absolute  top-10 right-10 w-32 h-32 bg-tabiya-accent/20 rounded-full blur-xl animate-pulse"></div>
        <div className="absolute bottom-20 left-10 w-24 h-24 bg-white/15 rounded-full blur-lg animate-bounce"></div>
        <div className="absolute top-1/2 left-1/4 w-16 h-16 bg-tabiya-accent/30 rotate-45 blur-md animate-spin"></div>
        <div className="absolute top-20 left-1/2 w-20 h-20 bg-white/10 rounded-full blur-lg animate-pulse"></div>
      ...
      <div className="w-full relative z-10">
        <div className="flex flex-col lg:flex-row items-center min-h-[600px] lg:min-h-[700px] gap-12 lg:gap-16">
          ...
          <div className="flex-1 lg:pr-10">
            <div className="max-w-none">
              <ScrollAnimation delay={0.2}>
                <h1 className="text-white font-sans text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-[110%] tracking-tight mb-8">
              ...
              <ScrollAnimation delay={0.4}>
                <p className="text-white/90  font-medium font-sans text-lg sm:text-xl leading-[140%] mb-10 max-w-2xl">
          ...
          <ScrollAnimationContainer
            ...
            staggerDelay={0.1}
          >
            <div className="absolute inset-0 bg-gradient-to-r from-tabiya-accent/5 to-transparent rounded-3xl blur-3xl"></div>
            ...
            <div className="relative grid grid-cols-2 gap-4 sm:gap-6 max-w-lg mx-auto">
              ...
              >
                <div className="relative group">
                  <div className="absolute inset-0 bg-tabiya-accent/20 rounded-2xl blur-lg group-hover:blur-xl transition-all duration-300"></div>
                  <img
                    ...
                    className="relative w-full aspect-[4/5] object-cover rounded-2xl shadow-2xl transform group-hover:scale-105 transition-all duration-500 border border-white/10"
                  />
