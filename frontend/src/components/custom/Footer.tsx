            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-4">
                  <button
                    className={`font-sans font-medium px-6 py-2 rounded-lg transition-all duration-300 ${
                      isDark
                  ...
                  <button
                    className={`font-sans font-medium px-6 py-2 rounded-lg transition-all duration-300 border ${
                      isDark
